...
# ============================================================================
#
# The infographic canvas uses 144 CSS pixels per printed inch. A 12-point
# printed font therefore equals 24 CSS pixels:
#
#   12 pt / 72 pt per inch * 144 CSS px per inch = 24 CSS px
#
...
INFOGRAPHIC_FIXED_LAYOUT <- list(
  data_font_px = infographic_pt_to_px(9),
  header_font_px = infographic_pt_to_px(9),
  chapter_font_px = infographic_pt_to_px(9),
  title_font_px = infographic_pt_to_px(9),
  subtitle_font_px = infographic_pt_to_px(9),
  panel_font_px = infographic_pt_to_px(9),
  group_font_px = infographic_pt_to_px(9),
  source_font_px = infographic_pt_to_px(9),
  row_padding_px = infographic_pt_to_px(2)
)
...
build_infographic_table <- function(
  ...
  css <- paste0(
    ...
    "font-size:", sizes$subtitle, "px;line-height:1.15;}",
    ...
    "px !important;line-height:1.15 !important;}",
    ...
    "#", id, " .gt_row {line-height:1.15 !important;}",
    ...
    "#", id, " .gt_source_notes {line-height:1.15 !important;",
    "padding-left:8px !important;padding-right:8px !important;}",
    "#", id, " .gt_col_heading {line-height:1.1 !important;}",
    if (nowrap_values) {
      paste0(
        "#", id,
...
export_paginated_infographic <- function(
  ...
  message(
    ...
    " for ", name, ". Body text is 12 pt at print size; row padding is fixed."
  )
