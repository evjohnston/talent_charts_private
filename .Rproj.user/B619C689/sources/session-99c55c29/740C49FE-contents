...
PUB <- list(
  ...
  # Unitless type metrics and letter spacing. Keeping these here prevents local
  # CSS/theme overrides from silently changing vertical rhythm.
  type_metrics = list(
    ...
    infographic_kicker_letterspace_pt      = 0.75,
    infographic_panel_label_letterspace_pt = 0.50,
    infographic_panel_title_letterspace_pt = 0.20
  ),
